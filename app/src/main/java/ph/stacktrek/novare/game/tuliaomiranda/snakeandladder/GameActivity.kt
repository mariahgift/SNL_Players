...
//        binding.playerTurnIndicator.text = playerDAO.getPlayers()[0].nickname
    ...
    private fun rollDice(){
        ...
        currentPlayer = (currentPlayer + 1)% playerDAO.getPlayers().size
        ...
        playerIndicator.text = "It's ${ playerDAO.getPlayers()[currentPlayer].nickname}'s Turn Current Position:${scores[currentPlayer]+1}"
        val numberOfPlayers = playerDAO.getPlayers().size
        if (numberOfPlayers == 1) {
